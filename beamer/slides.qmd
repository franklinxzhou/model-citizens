...
\begin{tabular}{l r}
\hline
\textbf{Model}  & \textbf{Public Score} \\
\hline
XGBoost   & 0.60600 \\
CatBoost  & 0.60491 \\
XGBoost   & 0.60352 \\
...
\begin{center}
\includegraphics[width=0.55\textwidth]{XGBoost_SHAP.png}
\end{center}

Compared to the feature importance plots in the last slide, **liab_prct**, **witness_present_ind**, and **in_network_bodyshop** 
...
- Cross-validation scores stable across folds/seeds
...
- Verified diversity via low–moderate prediction correlations
- Ensemble showed slight but consistent improvement over best single model
...
\hline
\textbf{Model} & \textbf{Private Score} & \textbf{Public} & \textbf{Note} \\
\hline

Ensemble & 0.58333 & 0.60866 & +0.4\% over the best single model \\
\hline

XGBoost & 0.57886 & 0.60600 & Best individual model \\
\hline

CatBoost & 0.57653 & 0.60491 & Handled categorical features well \\
\hline

TabM & 0.58325 & 0.60298 & Competitive deep-tabular model and consistent across seeds \\
\hline

LightGBM & 0.57168 & 0.59682 & Fast training but underperformed compared to XGBoost/CatBoost \\
\hline

Simple XGBoost & 0.50157 & 0.51584 & Benchmark \\
...
We predicted which auto insurance claims are likely to result in successful subrogation using a majority-vote ensemble of XGBoost, CatBoost, LightGBM, and TabM, which improved performance by 0.4% over the best single model.
