...
% ---------- LEFT COLUMN (DATA & FEATURE PIPELINE) ----------
...
\node (G) [boxL, below=of F] {Hyperparameter Tuning\\[-0.2em]{\scriptsize Optuna (F1 objective)}};

% ---------- RIGHT COLUMN (MODEL PIPELINE ONLY) ----------
\node (H) [boxR, right=3.6cm of G] {Model Training\\[-0.2em]{\scriptsize XGBoost (best params)}};
...
\node (K) [boxR,       above=of J] {Output\\[-0.2em]{\scriptsize Final CSV (claim\_number + subrogation)}};
